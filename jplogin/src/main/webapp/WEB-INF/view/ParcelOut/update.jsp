...
<body>
	<h3 style="padding: 10px 0 10px 400px;">분양글 수정</h3>
	<form id="file">
		<input type="hidden" value="">
		<c:forEach items="${petInfo}" var="info" varStatus="loop">
			<input type="hidden" name="MPNO" value="${info.MPNO}">
			<table class="table table-striped"
				style="text-align: left; border: 1px solid #dddddd; width: 100%; line-height: 100%;">
				<tr>
					<td
						style="width: 20%; border-right: 1px solid black; padding: 8px 0 8px 50px;">
						작성자ID&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input type="text"
						name="id" value="${authInfo.id}" readonly="readonly" size="30">
					</td>
					<td style="width: 20%; padding: 8px 0 8px 50px">
						제목&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input type="text"
						size="40" name="MPTITLE" value="${info.MPTITLE}" required="required">
					</td>
				</tr>
				<tr>
					<td
						style="width: 20%; border-right: 1px solid black; padding: 8px 0 8px 50px;">
						분류 &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <select id="MPDIVISION"
						name="MPDIVISION" required="required" style="width: 200px;">
							<option value=''></option>
					...
					<td style="width: 20%; padding: 8px 0 8px 50px">품종
						&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <select id="zoo2"
						name="MPKIND" required="required" style="width: 200px;">
							<option value=''></option>
					</select>
					</td>
				</tr>
				<tr>
					<td
						style="width: 100%; padding: 8px 0 8px 50px; border-right: 1px solid black;">
						크기 &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <select id="size"
						name="MPSIZE" required="required" style="width: 200px;">
							<option value=''></option>
					...
					<td style="width: 100%; padding: 8px 0 8px 50px">성별
						&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <select id="gender"
						name="MPGENDER" required="required" style="width: 200px;">
							<option value=''></option>
				...
				<tr>
					<td
						style="width: 20%; padding: 8px 0 8px 50px; border-right: 1px solid black;">
						책임비 &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; 
						<input type="text" id="charge"name="MPDEPOSIT" required="required" style="width: 200px;">
						
					</td>
					<td style="width: 20%; padding: 8px 0 8px 50px">지역
						&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <select id="location"
						name="MPLOCATION" required="required" style="width: 200px;">
							<option value=''></option>
				...
				<tr>
					...
					<td colspan="5" style="border-left: 1px solid black;"><input
						type="radio" value="Y" name="MPNEUTRAL" required="required">
						예 <input type="radio" value="N" name="MPNEUTRAL" required="required">아니요</td>
				</tr>
				<tr>
					<td style="width: 20%; padding: 8px 0 8px 50px;">반려동물 번호 확인
					<td colspan="5" id="regCheck" style="border-left: 1px solid black;">
						<input type="text" name="MPREGISTRATION" id="registration"
						required="required"> <input type="button" id="regChk"
						value="동물등록번호 확인">
					</td>
				</tr>
				...
				<tr>
					<td style="width: 20%; padding: 8px 0 8px 50px;"><input
						type="file" name="pic" id="pic" multiple required="required"></td>
				...
				<tr>
					<td colspan="5"><textarea name="MPCONTENT" required="required"
							style="resize: none; height: 400px; width: 100%">${info.MPCONTENT}</textarea></td>
				</tr>
			</table>
		</c:forEach>
		<div
			style="width: 100%; height: 100px; border: 1px solid black; text-align: center; padding: 30px 100px;">
			<input type="button" id=enrollment value="등록하기"
				style="width: 100px; height: 30px; margin: 0 50px 0 0;"> <input
				type="reset" value="취소"
				style="width: 100px; height: 30px; margin: 0 0 0 50px;">
		</div>
	</form>
</body>
</html>
			...
			.ready(
					function(e) {
						...
						$('#regChk')
								.click(
										function() {
											$
													.ajax({
														url : "${pageContext.request.contextPath}/parcelOut/regCheck",
														type : "POST",
														data : {
															"registration" : $(
																	'#registration')
						 ...
						 $("#MPDIVISION").on("change",function() {
								var ch = $("#MPDIVISION option:selected").val()
								if (ch == "") {
									$("#zoo2").html("");
								}
								if (ch == "고양이") {
						...
						$('#enrollment').click(function() {
                            ...
                            $.ajax({
                                url : "${pageContext.request.contextPath}/parcelOut/update",
