			...
			<section id="container">
				...
				<div id="container_box">
					...
					<form role="form" method="post" autocomplete="off"
						...
						<input type="hidden" name="petnum" value="${reviews.petnum}">



						<div class="inputArea">
							<label style="font-size: 20px; width: 100px;">1차 분류</label> <select
								class="category1" style="width: 350px; height: 30px;">
								<option value="">전체</option>
							</select> <label style="font-size: 20px; width: 100px;">2차 분류</label> <select
								class="category2" name="petcatecode"
						...
						<div class="inputArea">
							<label for="petname" style="font-size: 20px;">제목</label> <input
								type="text" id="petname" name="petname"
								style="width: 780px; height: 30px;" />
						</div>

						<div class="inputArea">
							<label for="petcontents" style="font-size: 20px; width: 100px;">내용</label>
							<textarea rows="10" cols="100" id="petcontents"
								name="petcontents" style="width: 1000px; height: 500px;"></textarea>
						</div>

						<div class="inputArea">
							<<label for="petimage" style="font-size: 20px; width: 100px;">이미지</label>
							<input type="file" id="petimage" name="file"
								style="width: 200px; height: 50px;" />
							<div class="select_img">
								<img
									src="${pageContext.request.contextPath}/${reviews.petimage}" />
								<input type="hidden" name="gdsImg" value="${reviews.petimage}" />
								<input type="hidden" name="gdsThumbImg"
									value="${reviews.petthumbimage}" />
							</div>
						...
						<div class="inputArea">
							<button type="submit" id="update_Btn" class="btn btn-primary"
								style="width: 200px;">완료</button>
							<button type="button" id="back_Btn" class="btn btn-warning"
								style="width: 200px;">취소</button>
						</div>
					</form>
					...
					<script>
						$("#back_Btn")
								.click(
										function() {
											location.href = '${pageContext.request.contextPath}/Review/reviewView?n=${reviews.petnum}'
