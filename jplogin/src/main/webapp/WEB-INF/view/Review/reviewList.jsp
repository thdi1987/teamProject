						...
						<tbody>
							<c:forEach items="${list}" var="list">
								<tr>
									<td>${list.petnum}</td>
									<td><a
										href="${pageContext.request.contextPath}/Review/reviewView?n=${list.petnum}">${list.petname}</a>
									</td>
									<td>${list.petcatecode}</td>
									<td><fmt:formatDate value="${list.petdate}"
