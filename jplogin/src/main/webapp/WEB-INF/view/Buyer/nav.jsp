...
<ul class="nav">
	...
	<li class="navl"><a class="nava" href="${pageContext.request.contextPath}/Notice/listUser">목록</a></li>	
	...
	<li class="navl"><a class="nava" href="${pageContext.request.contextPath}/Notice/listSys">목록</a></li>	
