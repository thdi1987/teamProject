						...
						$(".write_btn")
								.on(
										...
										function() {
											...
											formObj
													.attr("action",
															"${pageContext.request.contextPath}/freeboard/write");
		...
		<div class="container">
			<section id="container">
				...
				<form name="writeForm" method="post"
					action="${pageContext.request.contextPath}/freeboard/write">
						...
						<tbody>
							<tr>
								...
								<td colspan="3" style="border-left: 1px solid black;"><input
									type="text" id="fbtitle" name="fbtitle" class="chk"
									title="제목을 입력하세요" required="required" style="width: 900px" /></td>
							</tr>
							<tr>
								<td>작성자</td>
								<td colspan="3" style="border-left: 1px solid black;"><input
									type="text" id="fbwriter" name="fbwriter" title="작성자를 입력하세요"
									required="required" style="width: 900px" /></td>
							</tr>
							<tr>
								<td>내 용</td>
							...
							<tr>
								<td>비밀번호</td>
								<td colspan="3" style="border-left: 1px solid black;"><input
									type="password" id="fbpwd" name="fbpwd" required="required"
					...
					<div>
						<button type="submit"
							style="margin: 0 0 5rem 43rem; width: 25rem; height: 7rem; border-radius: 1rem; background: #c28af4; font-size: 4rem;"> 완 료 </button>
					</div>
				</form>
			</section>
		</div>
