...
<ul class="nav">
	<c:if test="${empty authInfo}">	
		<li class="navl"><a class="nava" href="${pageContext.request.contextPath}/Quest/writeView">문의하기</a></li>
	...
	<li class="navl"><a class="nava" href="${pageContext.request.contextPath}/Service/writeView">글 작성</a></li>	
	<li class="navl"><a class="nava" href = "<c:url value="/member/logout"/>">로그아웃</a></li>
	</c:if>
</ul>
