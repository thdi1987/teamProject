        ...
        <div class="card card-signin my-5" style=" background:#f7f7f7; background-color: rgba( 255, 255, 255, 0.5 ); border-radius: 1px; ">
          <div class="card-body" style=" background:#f7f7f7; background-color: rgba( 255, 255, 255, 0.5 ); ">
            ...
            <form class="form-signin" id="signFrm" name="signFrm"
					action="${pageContext.request.contextPath}/member/writeParcelOut"
              ...
              <div class="form" style="height:50px;">
               ...
               <div class="form" style="height:50px;">
                <input type="text" id="MREGISTRATION" class="form-control" name="MREGISTRATION" placeholder="동물등록번호 입력" required style=" width:600px;border-radius: 1px; float:left; margin-top:10px;" >
                <button type="button" class="btn btn-primary" id = "regChk" name = "regChk"  style="width:183px;border-radius: 1px; float:left; margin-top:10px;">동물등록번호 확인</button>  
              </div>
															...
															if (data == 1
																...
																$(
																		...
																		.attr(
																				"readonly",
																				true);
																alert("사용가능한 동물등록번호 입니다.")

															} else {
																alert("사용불가능한 동물등록번호 입니다.")
															}
														},
														error : function() {
															alert("서버에러");
