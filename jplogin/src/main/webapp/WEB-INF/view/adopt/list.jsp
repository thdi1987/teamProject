...
<div id="wrapper">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div class="container-fluid">
            ...
            <h1 class="h3 mb-0 text-gray-800">입양신청내역</h1>
				</div>
					...
					<table class="table table-hover">
						...
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<td><a
									href="#" onclick="window.open('${pageContext.request.contextPath}/adopt/readViewSys?AANO=${list.AANO}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}','_blank','width=800,height=800')"><c:out
								...
								<c:if test="${!empty authInfo and authInfo.division == 'A1'}">
									<td><button type="button" id="selection" name="selection"
											class="selection btn  btn-primary">입양확인</button></td>
								</c:if>
								<c:if test="${!empty authInfo and authInfo.division == 'S1'}">
